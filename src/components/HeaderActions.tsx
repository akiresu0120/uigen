...
export function HeaderActions({ user, projectId }: HeaderActionsProps) {
    ...
    return (
      <>
        <div className="flex gap-2">
          ...
          <Button
            className="h-8 bg-gradient-to-br from-indigo-500 to-violet-600 text-white border-0 shadow-sm hover:shadow-md hover:opacity-90 transition-all"
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Button
        className="flex items-center gap-2 h-8 bg-gradient-to-br from-indigo-500 to-violet-600 text-white border-0 shadow-sm hover:shadow-md hover:opacity-90 transition-all"
